...
RSpec.describe GroupOperation, type: :model do
  ...
  it 'should increment total amount of group if created' do
    ...
    GroupOperation.create(group:, operation: operation1)
    GroupOperation.create(group:, operation: operation2)
  ...
  it 'should decrement total amount of group if deleted' do
    ...
    GroupOperation.create(group:, operation: operation1)
    destroyable = GroupOperation.create(group:, operation: operation2)
